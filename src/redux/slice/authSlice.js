...
import { checkUser, createUser, logout, updateUser } from "./authAPI";
...
export const logoutAsync = createAsyncThunk("users/logout", async (userId) => {
  const responce = await logout(userId);
  return responce.data;
});
